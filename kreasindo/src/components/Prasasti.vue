  ...
  <div class="prasasti-order">
    <div class="container">
      <div class="header">
        ...
        <h1 class="title">Pemesanan Prasasti</h1>
        <p class="subtitle">Pilih prasasti custom berkualitas sesuai kebutuhan Anda</p>
      </div>

      <div class="product-prasasti">
        <img src="/produk/prasasti.png" alt="Prasasti" />
        <div class="prasasti-overlay">
          <p>Abadikan momen bersejarah Anda dengan prasasti granit dan akrilik berkualitas tinggi yang elegan, tahan lama, dan terukir presisi.</p>
        </div>
      </div>
            ...
            <div class="material-grid">
              ...
              >
                ...
                <div class="material-info">
                  ...
                  <p class="material-price">{{ formatCurrency(material.price) }} / piece</p>
...
export default {
  ...
  data() {
    return {
      ...
      materialOptions: {
        akrilik: {
          name: 'Prasasti Akrilik 30 x 30 cm',
          price: 300000,
          design: false
        },
        granit: {
          name: 'Prasasti Granit 60 x 60 cm',
          price: 850000,
          design: false
        }
      },
      materialNames: {
        akrilik: 'Prasasti Akrilik 30 x 30 cm',
        granit: 'Prasasti Granit 60 x 60 cm'
      }
    }
  },
  computed: {
  ...
  methods: {
    generateOrderCode() {
      ...
      this.orderCode = `PsT${randomNum}08`;
    },
    saveCustomerData() {
