  ...
  <div class="nomorrumah-order">
    <div class="container">
      <div class="header">
        ...
        <h1 class="title">Pemesanan Nomor Rumah</h1>
        <p class="subtitle">Pilih nomor rumah berkualitas sesuai kebutuhan Anda</p>
      </div>

      <div class="product-nomorrumah">
        <img src="/produk/nomorrumah.png" alt="Nomor Rumah" />
        <div class="nomorrumah-overlay">
          <p>Nomor rumah berkualitas tinggi untuk identifikasi rumah Anda dengan desain premium.</p>
        </div>
      </div>
        ...
        <div class="card-body">
          ...
          <div class="form-row two-cols">
            <div class="form-group">
              ...
              <p class="helper-text">Ukuran tetap untuk nomor rumah</p>
            </div>
...
export default {
  ...
  data() {
    return {
      ...
      errorTitle: '',
      errorMessage: '',
      fixedSize: '15 x 25 cm',
      materialOptions: {
        nomorrumah: {
          name: 'Nomor Rumah Akrilik',
          price: 115000,
          design: false
        }
      },
      materialNames: {
        nomorrumah: 'Nomor Rumah Akrilik'
      }
    }
  },
  computed: {
  ...
  methods: {
    generateOrderCode() {
      ...
      this.orderCode = `RmH${randomNum}06`;
    },
    saveCustomerData() {
    ...
    sendToWhatsApp() {
      ...
      let message = `*PESANAN NOMOR RUMAH*\n\n`;
