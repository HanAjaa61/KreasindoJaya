  ...
  <div class="banner-order">
    <div class="container">
      <div class="header">
        ...
        <h1 class="title">Pemesanan Roll Banner</h1>
        <p class="subtitle">Pilih roll banner berkualitas sesuai kebutuhan Anda</p>
      </div>

      <div class="product-banner">
        <img src="/produk/rollupbanner.png" alt="Banner" />
        <div class="banner-overlay">
          <p>Stand banner premium dengan mekanisme gulung yang ringkas, memberikan tampilan profesional untuk lobi atau pameran.</p>
        </div>
      </div>
        ...
        <div class="card-body">
            ...
            <div class="material-grid">
              ...
              >
                ...
                <div class="material-info">
                  ...
                  <p class="material-price">{{ formatCurrency(material.price) }} / banner</p>
          ...
          <div class="form-row two-cols">
            <div class="form-group">
              ...
              <p class="helper-text">Ukuran tetap untuk banner</p>
            </div>
...
export default {
  ...
  data() {
    return {
      ...
      errorTitle: '',
      errorMessage: '',
      fixedSize: '60 x 160 cm',
      materialOptions: {
        flexi280: {
          name: 'Roll banner Flexi 280 GSM',
          price: 400000,
          design: true
        },
        flexikorea440: {
          name: 'Roll banner Flexi Korea 440 GSM',
          price: 425000,
          design: true
        },
        luster: {
          name: 'Roll banner Luster',
          price: 450000,
          design: true
        }
      },
      materialNames: {
        flexi280: 'Roll banner Flexi 280 GSM',
        flexikorea440: 'Roll banner Flexi Korea 440 GSM',
        luster: 'Roll banner Luster'
      }
    }
  },
  computed: {
  ...
  methods: {
    generateOrderCode() {
      ...
      this.orderCode = `RbR${randomNum}05`;
    },
    saveCustomerData() {
    ...
    sendToWhatsApp() {
      ...
      let message = `*PESANAN ROLL BANNER*\n\n`;
