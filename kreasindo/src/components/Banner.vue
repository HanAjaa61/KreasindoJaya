  ...
  <div class="banner-order">
    <div class="container">
      <div class="header">
        ...
        <h1 class="title">Pemesanan Banner</h1>
        <p class="subtitle">Pilih banner berkualitas sesuai kebutuhan Anda</p>
      </div>

      <div class="product-banner">
        <img src="/produk/banner.png" alt="Banner" />
        <div class="banner-overlay">
          <p>Display promosi praktis yang mudah dibawa dan dipasang, sangat cocok untuk event, seminar, atau di depan toko.</p>
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      materialOptions: {
        flexi280: {
          name: 'X / Y Banner Flexi 280 GSM',
          price: 185000,
          design: true
        },
        flexikorea440: {
          name: 'X / Y Banner Flexi Korea 440 GSM',
          price: 200000,
          design: true
        },
        luster: {
          name: 'X / Y Banner Luster',
          price: 225000,
          design: true
        }
      },
      materialNames: {
        flexi280: 'X / Y Banner Flexi 280 GSM',
        flexikorea440: 'X / Y Banner Flexi Korea 440 GSM',
        luster: 'X / Y Banner Luster'
      }
    }
  },
  computed: {
  ...
  methods: {
    generateOrderCode() {
      ...
      this.orderCode = `BnR${randomNum}04`;
    },
    saveCustomerData() {
