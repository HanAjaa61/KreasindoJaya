  ...
  <div class="pialamendali-order">
    <div class="container">
      <div class="header">
        ...
        <h1 class="title">Pemesanan Piala & Mendali</h1>
        <p class="subtitle">Pilih piala dan mendali custom berkualitas sesuai kebutuhan Anda</p>
      </div>

      <div class="product-pialamendali">
        <img src="/produk/pialamendali.png" alt="Pialamendali" />
        <div class="pialamendali-overlay">
          <p>Piala dan mendali custom premium dengan desain dan percetakan berkualitas tinggi, tahan lama dan cocok untuk penghargaan atau keperluan lomba.</p>
        </div>
      </div>
      ...
      <div v-for="(order, index) in orders" :key="index" class="order-card">
        ...
        <div class="card-body">
            ...
            <div class="material-grid">
              ...
              >
                ...
                <div class="material-info">
                  ...
                  <p class="material-price" v-if="material.price > 0">{{ formatCurrency(material.price) }} / piece</p>
                  <p class="material-price custom-price" v-else>Konfirmasi via WhatsApp</p>
          ...
          <div class="form-row" v-if="order.material">
            <div class="form-group">
              ...
              <p class="helper-text">Jumlah yang dipesan</p>
            </div>
          </div>

          <div class="screenshot-guide" v-if="order.material && order.material !== 'custom'">
  ...
  <div class="guide-content">
    ...
    <div class="guide-footer">
      <span>Catatan: Pesanan tanpa lampiran screenshot yang valid dapat ditolak atau dengan kesepakatan bersama !</span>
          ...
          <div class="price-summary" v-if="order.material && order.unitPrice > 0">
            <div class="price-row">
          ...
          <div class="custom-note" v-if="order.material === 'custom'">
            <div class="note-icon">
            ...
            <div class="note-content">
              ...
              <p>Untuk produk custom, harga akan dikonfirmasi langsung melalui WhatsApp berdasarkan spesifikasi yang Anda inginkan.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="grand-total-section">
          <div class="total-content">
            ...
            <div class="total-info">
              ...
              <p class="total-amount" v-if="grandTotal > 0">{{ formatCurrency(grandTotal) }}</p>
              <p class="total-amount custom-confirm" v-else>Konfirmasi via WhatsApp</p>
            </div>
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      materialOptions: {
        ...
        custom: {
          name: 'Piala & Mendali Custom',
          price: 0,
          design: false
        }
      },
      materialNames: {
        piala: 'Piala Satu Set (Isi 3)',
        mendali: 'Mendali',
        custom: 'Piala & Mendali Custom'
      }
    }
  },
  computed: {
  ...
  methods: {
    generateOrderCode() {
      ...
      this.orderCode = `PmD${randomNum}07`;
    },
    saveCustomerData() {
    ...
    sendToWhatsApp() {
      ...
      let message = `*PESANAN PIALA & MENDALI*\n\n`;
      ...
      this.orders.forEach((order, index) => {
        ...
        if (order.material === 'custom') {
          message += `Harga: Konfirmasi via WhatsApp\n`;
        } else {
      ...
      if (this.grandTotal > 0) {
        ...
        message += `*TOTAL KESELURUHAN: Konfirmasi via WhatsApp*\n\n`;
      }
...
.product-pialamendali img {
  width: 100%;
  height: 100%;
  object-fit: cover;
}

.pialamendali-overlay {
  position: absolute;
  bottom: 0;
  left: 0;
  right: 0;
...
.material-card.selected .material-price.custom-price {
  color: #fde68a;
}
