  ...
  <div class="aksesoris-order">
    <div class="container">
      <div class="header">
        ...
        <h1 class="title">Pemesanan Aksesoris Custom</h1>
        <p class="subtitle">Pilih aksesoris custom berkualitas sesuai kebutuhan Anda</p>
      </div>

      <div class="product-aksesoris">
        <img src="/produk/aksesoris.png" alt="Aksesoris" />
        <div class="aksesoris-overlay">
          <p>Lengkapi gayamu dengan set aksesoris custom premium. Topi, lanyard, dan keychain dengan desain unik untuk identitas yang lebih berkelas.</p>
        </div>
      </div>
...
export default {
  ...
  methods: {
    generateOrderCode() {
      ...
      this.orderCode = `AsR${randomNum}04`;
    },
    saveCustomerData() {
