  ...
  <div class="rambu-order">
    <div class="container">
      <div class="header">
        ...
        <h1 class="title">Pemesanan Rambu-Rambu</h1>
        <p class="subtitle">Pilih rambu-rambu berkualitas sesuai kebutuhan Anda</p>
      </div>

      <div class="product-rambu">
        <img src="/produk/rambu.png" alt="Rambu-Rambu" />
        <div class="rambu-overlay">
          <p>Rambu-rambu sebagai media informasi dan petunjuk yang dirancang jelas, mudah dibaca, dan sesuai standar penggunaan.</p>
        </div>
      </div>
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <p class="address-note">
              <strong>Catatan :</strong> Alamat akan digunakan untuk survey lokasi pemasangan rambu-rambu.
            </p>
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      materialOptions: {
        neon60x90print: {
          name: 'rambu-rambu 40 x 60 cm',
          price: 240000,
          shape: 'square'
        },
        neon60x90back: {
          name: 'rambu-rambu 60 x 60 cm',
          price: 360000,
          shape: 'square'
        }
      },
  ...
  methods: {
    generateOrderCode() {
      ...
      this.orderCode = `RmB${randomNum}04`;
    },
    saveCustomerData() {
    ...
    sendToWhatsApp() {
      ...
      let message = `*PESANAN RAMBU-RAMBU*\n\n`;
