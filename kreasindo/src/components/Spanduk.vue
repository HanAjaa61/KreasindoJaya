  ...
  <div class="spanduk-order">
    <div class="container">
      ...
      <div class="product-banner">
        <img src="/produk/spanduk.png" alt="Spanduk dan Brosur" />
        <div class="banner-overlay">
          <p>Media promosi efektif untuk menjangkau audiens luas dengan cetakan warna tajam dan bahan yang tahan cuaca.</p>
        </div>
      </div>
      ...
      <div v-for="(order, index) in orders" :key="index" class="order-card">
        ...
        <div class="card-body">
          ...
          <div class="form-row two-cols">
            <div class="form-group">
              <label>Panjang <span class="required">*</span></label>
              ...
              <p class="helper-text">Panjang spanduk</p>
            </div>

            <div class="form-group">
              <label>Lebar <span class="required">*</span></label>
              <div class="input-with-unit">
                <input 
                  v-model="order.width" 
                  type="number" 
              ...
              <p class="helper-text">Lebar spanduk</p>
            </div>
          </div>
      ...
      <span>Catatan: Pesanan tanpa lampiran screenshot yang valid dapat ditolak atau dengan kesepakatan bersama !</span>
          ...
          <div class="price-summary">
            <div class="price-row">
              ...
              <span class="price-value">{{ order.area }} m²</span>
            </div>
            <div class="price-row">
...
export default {
  ...
  methods: {
    generateOrderCode() {
      ...
      this.orderCode = `SpD${randomNum}01`;
    },
    ...
    sendToWhatsApp() {
      ...
      let message = `*PESANAN SPANDUK DAN BROSUR*\n\n`;
      ...
      this.orders.forEach((order, index) => {
        ...
        message += `Ukuran: Panjang ${order.length}m x Lebar ${order.width}m (${order.area} m²)\n`;
        message += `Kuantitas: ${order.quantity} pcs\n`;
        message += `Harga Satuan: ${this.formatCurrency(order.unitPrice)}\n`;
        message += `Subtotal: ${this.formatCurrency(order.totalPrice)}\n`;
      });
