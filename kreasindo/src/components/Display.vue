  ...
  <div class="display-order">
    <div class="container">
      <div class="header">
        ...
        <h1 class="title">Pemesanan Display QRIS</h1>
        <p class="subtitle">Pilih display QRIS berkualitas sesuai kebutuhan Anda</p>
      </div>

      <div class="product-display">
        <img src="/produk/displayqris.png" alt="Display QRIS" />
        <div class="display-overlay">
          <p>Display QRIS untuk menjaga dan menampilkan QRIS fisik dengan desain premium.</p>
        </div>
      </div>
        ...
        <div class="card-body">
          ...
          <div class="form-row two-cols">
            <div class="form-group">
              ...
              <p class="helper-text">Ukuran tetap untuk display QRIS</p>
            </div>
...
export default {
  ...
  methods: {
    generateOrderCode() {
      ...
      this.orderCode = `QrS${randomNum}05`;
    },
    saveCustomerData() {
    ...
    sendToWhatsApp() {
      ...
      let message = `*PESANAN DISPLAY QRIS*\n\n`;
