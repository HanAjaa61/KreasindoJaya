  ...
  <div class="nametag-order">
    <div class="container">
      <div class="header">
        ...
        <h1 class="title">Pemesanan Nametag</h1>
        <p class="subtitle">Pilih nametag berkualitas sesuai kebutuhan Anda</p>
      </div>

      <div class="product-banner">
        <img src="/produk/nametag.jpg" alt="Nametag" />
        <div class="banner-overlay">
          <p>Tanda pengenal staf yang awet dan rapi, dirancang untuk memperkuat kredibilitas perusahaan di mata pelanggan.</p>
        </div>
      </div>
        ...
        <div class="card-body">
            ...
            <div class="material-grid">
              ...
              >
                ...
                <div class="material-info">
                  ...
                  <p class="material-price">{{ formatCurrency(material.price) }} / nametag</p>
          ...
          <div class="form-row two-cols">
            <div class="form-group">
              ...
              <p class="helper-text">Ukuran tetap untuk nametag</p>
            </div>
...
export default {
  ...
  data() {
    return {
      ...
      materialNames: {
        peniti: 'Nametag Peniti',
        magnet: 'Nametag Magnet'
      }
    }
  },
  computed: {
  ...
  methods: {
     generateOrderCode() {
      ...
      this.orderCode = `NmG${randomNum}07`;
    },
