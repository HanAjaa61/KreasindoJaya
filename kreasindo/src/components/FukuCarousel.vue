<template>
  <section id="fukucarousel" v-if="displayedProducts.length > 0" class="fuku-catalog">
    <div class="container">
      <h2 class="section-title">Fuku</h2>
      <p class="section-subtitle">Brand terbaru dari CV. Kreasindo Jaya yang menghadirkan layanan custom merchandise
          dan souvenir dengan desain eksklusif dan kualitas terbaik sesuai keinginan Anda.</p>
...
<script>
import FukuProducts from '@/data/fuku.json';
...
.fuku-catalog {
  background: linear-gradient(180deg, #191970 0%, #191970 40%, #1a1a4d 100%);
