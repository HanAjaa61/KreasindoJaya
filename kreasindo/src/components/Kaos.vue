  ...
  <div class="kaos-order">
    <div class="container">
      <div class="header">
        ...
        <h1 class="title">Pemesanan Kaos</h1>
        <p class="subtitle">Pilih kaos berkualitas sesuai kebutuhan Anda</p>
      </div>

      <div class="product-kaos">
        <img src="/produk/kaos.png" alt="Kaos" />
        <div class="kaos-overlay">
          <p>Tingkatkan identitas tim atau komunitas Anda dengan kaos custom berkualitas dengan bahan knito yang mencerminkan kepribadian dan nilai bersama secara eksklusif.</p>
        </div>
      </div>
      ...
      <div v-for="(order, index) in orders" :key="index" class="order-card">
        ...
        <div class="card-body">
          <div class="form-group">
            <label class="main-label">Pilih Jenis Kaos <span class="required">*</span></label>
          ...
          <div class="form-group" v-if="order.category">
            <label class="main-label">Pilih Tipe Kaos <span class="required">*</span></label>
            <div class="type-grid">
              <div 
...
export default {
  ...
  methods: {
    generateOrderCode() {
      ...
      this.orderCode = `KaO${randomNum}01`;
    },
    saveCustomerData() {
    ...
    sendToWhatsApp() {
      ...
      this.orders.forEach((order, index) => {
        ...
        message += `Jenis Kaos: ${this.categoryOptions[order.category].name}\n`;
        message += `Tipe Kaos: ${this.typeOptions[order.type].name}\n`;
