  ...
  <div class="a3-order">
    <div class="container">
      <div class="header">
        ...
        <h1 class="title">Pemesanan Stiker A3 </h1>
        <p class="subtitle">Pilih stiker A3 berkualitas sesuai kebutuhan Anda</p>
      </div>

      <div class="product-banner">
        <img src="/produk/stikera3.png" alt="Stiker A3" />
        <div class="banner-overlay">
          <p>Label kemasan serbaguna (Bontak/Vinyl) dalam format A3, ideal untuk branding produk UMKM dengan hasil potong presisi.</p>
        </div>
      </div>
        ...
        <div class="card-body">
            ...
            <div class="material-grid">
              ...
              >
                ...
                <div class="material-info">
                  ...
                  <p class="material-price">{{ formatCurrency(material.price) }} / lembar</p>
                  <div class="material-badge" v-if="material.design">+ Cutting</div>
                </div>
          ...
          <div class="form-row two-cols">
            <div class="form-group">
              ...
              <p class="helper-text">Ukuran tetap untuk stiker A3</p>
            </div>
...
export default {
  ...
  data() {
    return {
      ...
      materialOptions: {
        ...
        vinilbeningnoncutting: {
          name: 'Stiker Vinil Bening',
          price: 17000,
          design: false
        },
        vinilbeningcutting: {
        ...
        vinilputihnoncutting: {
          name: 'Stiker Vinil Putih',
          price: 17000,
          design: false
        },
        vinilputihcutting: {
      ...
      materialNames: {
        bontakcutting: 'Stiker Bontak Cutting',
        bontaknoncutting: 'Stiker Bontak Non-Cutting',
        vinilbeningcutting: 'Stiker Vinil Bening Cutting',
        vinilbeningnoncutting: 'Stiker Vinil Bening Non-Cutting',
        vinilputihcutting: 'Stiker Vinil Putih Cutting',
        vinilputihnoncutting: 'Stiker Vinil Putih Non-Cutting'
      }
    }
  },
  computed: {
  ...
  methods: {
    generateOrderCode() {
      ...
      this.orderCode = `StR3${randomNum}08`;
    },
