<template>
  <section v-if="displayedProducts.length > 0" class="printing-catalog">
    <div class="container">
      <h2 class="section-title">Souvenir & Ornamen</h2>
      <p class="section-subtitle">Berbagai souvenir & ornamen bermutu tinggi dengan desain yang indah untuk kebutuhan Anda</p>
...
<script>
import SouvenirProducts from '@/data/souvenir.json';

export default {
  name: 'SouvenirCarousel',
  props: {
    searchQuery: {
      type: String,
      default: ''
  ...
  mounted() {
    this.products = SouvenirProducts;
    this.emitKeywords();
    this.checkMobile();
