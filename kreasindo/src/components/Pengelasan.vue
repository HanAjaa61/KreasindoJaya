  ...
  <div class="welding-order">
    <div class="container">
      <div class="header">
        ...
        <h1 class="title">Pemesanan Las</h1>
        <p class="subtitle">Pilih jasa pengelasan berkualitas sesuai kebutuhan Anda</p>
      </div>

      <div class="product-welding">
        <img src="/produk/welding.png" alt="Las" />
        <div class="welding-overlay">
          <p>Melayani pemesanan las untuk berbagai kebutuhan konstruksi seperti kontainer booth, teralis, pagar, dan kanopi dengan pengerjaan rapi, material berkualitas, serta hasil yang kuat dan tahan lama.</p>
        </div>
      </div>
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <p class="address-note">
              <strong>Catatan :</strong> Alamat akan digunakan untuk survey lokasi pengerjaan las.
            </p>
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      productOptions: {
        ...
        booth1x15: {
          name: 'Kontainer Booth 1 x 1.5 meter'
        },
        booth15x2: {
          name: 'Kontainer Booth 1.5 x 2 meter'
        },
        partisikaca: {
          name: 'Partisi Kaca'
        },
      ...
      productNames: {
        ...
        teralis: 'Teralis',
        pagar: 'Pagar',
        booth1x15: 'Kontainer Booth 1 x 1.5 meter',
        booth15x2: 'Kontainer Booth 1.5 x 2 meter',
        partisikaca: 'Partisi Kaca',
        acp: 'ACP'
  ...
  methods: {
    generateOrderCode() {
      ...
      this.orderCode = `LaS${randomNum}02`;
    },
    saveCustomerData() {
