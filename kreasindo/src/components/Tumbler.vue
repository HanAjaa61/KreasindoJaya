  ...
  <div class="tumbler-order">
    <div class="container">
      <div class="header">
        ...
        <h1 class="title">Pemesanan Tumbler Custom</h1>
        <p class="subtitle">Pilih tumbler custom berkualitas sesuai kebutuhan Anda</p>
      </div>

      <div class="product-tumbler">
        <img src="/produk/tumbler.png" alt="Tumbler" />
        <div class="tumbler-overlay">
          <p>Tumbler custom premium dengan cetakan berkualitas tinggi, tahan lama dan cocok untuk hadiah atau keperluan kantor.</p>
        </div>
      </div>
            ...
            <div class="material-grid">
              ...
              >
                ...
                <div class="material-info">
                  ...
                  <p class="material-price">{{ formatCurrency(material.price) }} / tumbler</p>
            ...
            <div class="form-group">
              ...
              <div class="quantity-control">
                ...
                <input 
                  ...
                  type="number" 
                  :min="getMinQty(order.material)"
                  :max="getMaxQty(order.material)"
                  step="1"
                  class="qty-input"
                  @input="validateAndCalculatePrice(index)"
              ...
              <p class="helper-text" v-if="order.material">
                Range: {{ getMinQty(order.material) }} - {{ getMaxQty(order.material) }} pcs
              </p>
              <p class="helper-text" v-else>Pilih jenis produk terlebih dahulu</p>
            </div>
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      materialOptions: {
        tumbler13: {
          name: 'Tumbler LED / Sublim 1-3 Piece',
          price: 80000,
          minQty: 1,
          maxQty: 3,
          design: false
        ...
        tumbler49: {
          name: 'Tumbler LED / Sublim 4-9 Piece',
          price: 77000,
          minQty: 4,
          maxQty: 9,
          design: false
        ...
        tumbler1016: {
          name: 'Tumbler LED / Sublim 10-16 Piece',
          price: 74000,
          minQty: 10,
          maxQty: 16,
          design: false
        ...
        tumbler1724: {
          name: 'Tumbler LED / Sublim 17-24 Piece',
          price: 70000,
          minQty: 17,
          maxQty: 24,
          design: false
        ...
        tumbler25: {
          name: 'Tumbler LED / Sublim 25 Piece Atau Lebih',
          price: 67000,
          minQty: 25,
          maxQty: 9999,
          design: false
      ...
      materialNames: {
        tumbler13: 'Tumbler LED / Sublim 1-3 Piece',
        tumbler49: 'Tumbler LED / Sublim 4-9 Piece',
        tumbler1016: 'Tumbler LED / Sublim 10-16 Piece',
        tumbler1724: 'Tumbler LED / Sublim 17-24 Piece',
        tumbler25: 'Tumbler LED / Sublim 25 Piece atau Lebih'
      }
    }
  },
  computed: {
  ...
  methods: {
    generateOrderCode() {
      ...
      this.orderCode = `TbR${randomNum}02`;
    },
    getMinQty(material) {
      return material ? this.materialOptions[material].minQty : 1;
    },
    getMaxQty(material) {
      return material ? this.materialOptions[material].maxQty : 1;
    },
    canDecreaseQty(index) {
      const order = this.orders[index];
      if (!order.material) return false;
      return order.quantity > this.getMinQty(order.material);
    },
    canIncreaseQty(index) {
      const order = this.orders[index];
      if (!order.material) return false;
      return order.quantity < this.getMaxQty(order.material);
    },
    saveCustomerData() {
    ...
    selectMaterial(index, key) {
      ...
      this.orders[index].quantity = this.materialOptions[key].minQty;
    ...
    increaseQty(index) {
      ...
      const maxQty = this.getMaxQty(order.material);
    ...
    decreaseQty(index) {
      ...
      const minQty = this.getMinQty(order.material);
      if (order.quantity > minQty) {
        order.quantity--;
        this.calculatePrice(index);
      }
    },
    validateAndCalculatePrice(index) {
      const order = this.orders[index];
      ...
      if (order.quantity) {
        ...
        if (order.quantity > maxQty) order.quantity = maxQty;
      } else {
    ...
    calculatePrice(index) {
      ...
      const pricePerPiece = this.materialOptions[order.material].price;
      order.unitPrice = pricePerPiece;
