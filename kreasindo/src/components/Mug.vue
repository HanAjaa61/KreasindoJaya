  ...
  <div class="mug-order">
    <div class="container">
      <div class="header">
        ...
        <h1 class="title">Pemesanan Mug Custom</h1>
        <p class="subtitle">Pilih mug custom berkualitas sesuai kebutuhan Anda</p>
      </div>

      <div class="product-mug">
        <img src="/produk/mug.png" alt="Mug" />
        <div class="mug-overlay">
          <p>Mug custom premium dengan cetakan berkualitas tinggi, tahan lama dan cocok untuk hadiah atau keperluan kantor.</p>
        </div>
      </div>
            ...
            <div class="material-grid">
              ...
              >
                ...
                <div class="material-info">
                  ...
                  <p class="material-price">{{ formatCurrency(material.price) }} / mug</p>
...
export default {
  ...
  data() {
    return {
      ...
      materialNames: {
        mug13: 'Mug 1-3 Piece',
        mug49: 'Mug 4-9 Piece',
        mug1016: 'Mug 10-16 Piece',
        mug1724: 'Mug 17-24 Piece',
        mug25: 'Mug 25 Piece atau Lebih'
      }
    }
  },
  computed: {
  ...
  methods: {
    generateOrderCode() {
      ...
      this.orderCode = `MuG${randomNum}01`;
    },
    getMinQty(material) {
