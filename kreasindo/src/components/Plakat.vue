  ...
  <div class="plakat-order">
    <div class="container">
      <div class="header">
        ...
        <h1 class="title">Pemesanan Plakat Custom</h1>
        <p class="subtitle">Pilih plakat custom berkualitas sesuai kebutuhan Anda</p>
      </div>

      <div class="product-plakat">
        <img src="/produk/plakat.png" alt="Plakat" />
        <div class="plakat-overlay">
          <p>Plakat custom premium dengan cetakan berkualitas tinggi, tahan lama dan cocok untuk hadiah atau keperluan kantor.</p>
        </div>
      </div>
            ...
            <div class="material-grid">
              ...
              >
                ...
                <div class="material-info">
                  ...
                  <p class="material-price" v-if="material.price > 0">{{ formatCurrency(material.price) }} / pcs</p>
...
export default {
  ...
  data() {
    return {
      ...
      materialNames: {
        ...
        plakat5: 'Plakat 5mm',
        plakat8: 'Plakat 8mm',
        plakat10: 'Plakat 10mm',
        kotakplakat: 'Kotak Plakat',
        custom: 'Plakat Custom'
      }
    }
  },
  computed: {
  ...
  methods: {
    generateOrderCode() {
      ...
      this.orderCode = `PlK${randomNum}03`;
    },
    saveCustomerData() {
