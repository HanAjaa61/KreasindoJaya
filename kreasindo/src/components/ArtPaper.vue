  ...
  <div class="artpaper-order">
    <div class="container">
      <div class="header">
        ...
        <h1 class="title">Pemesanan Art Paper</h1>
        <p class="subtitle">Pilih art paper berkualitas sesuai kebutuhan Anda</p>
      </div>

      <div class="product-banner">
        <img src="/produk/artpaper.jpg" alt="Art Paper" />
        <div class="banner-overlay">
          <p>Kertas berkualitas dengan permukaan licin dan mengkilap, pilihan terbaik untuk cetak menu, sertifikat, atau poster.</p>
        </div>
      </div>
        ...
        <div class="card-body">
          ...
          <div class="form-row two-cols">
            <div class="form-group">
              ...
              <p class="helper-text">Ukuran tetap untuk art paper</p>
            </div>
...
export default {
  ...
  data() {
    return {
      ...
      materialOptions: {
        tipis: {
          name: 'Art Paper Tipis 120-160 GSM',
          price: 10000,
          design: false
        },
        tebal: {
          name: 'Art Paper Tebal 180-260 GSM',
          price: 13000,
          design: false
      ...
      materialNames: {
        tipis: 'Art Paper Tipis 120-160 GSM',
        tebal: 'Art Paper Tebal 180-260 GSM'
      }
    }
  },
  computed: {
  ...
  methods: {
    generateOrderCode() {
      ...
      this.orderCode = `ApR${randomNum}09`;
    },
