<template>
  <section v-if="displayedProducts.length > 0" class="printing-catalog">
    <div class="container">
      ...
      <p class="section-subtitle">Tempat produksi reklame, konstruksi, dan pengelasan dengan standar kualitas tinggi dan pengerjaan presisi</p>
...
<script>
import workshopProducts from '@/data/workshop.json';

export default {
  name: 'WorkshopCarousel',
  props: {
    searchQuery: {
      type: String,
      default: ''
  ...
  mounted() {
    this.products = workshopProducts;
    this.emitKeywords();
    this.checkMobile();
